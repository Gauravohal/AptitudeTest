...
<body><center>
<div class="title">Programming Quiz</div>
<?php 															
                                ...
                                //  $c=40;
																...
																?>
<div class="bump"><br><form><?php if($_SESSION['clicks']==75){ ?> <button class="button" name="start" float="left"><span>START QUIZ</span></button> 
...
<table class="table1"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `quiz` where id='$c' and subid=4"; 
				$result=mysqli_query($conn,$fetchqry);
				$num=mysqli_num_rows($result);
				$row = mysqli_fetch_array($result,MYSQLI_ASSOC); }
		  ?>
<?php if($_SESSION['clicks'] > 75 && $_SESSION['clicks'] < 86){ 
  $button_name;
  if($_SESSION['clicks']<85)
  {
   $button_name = "Next";
  }
  else
 ...
 <br><br>
 <a href="http://localhost/aptitude%20Test%20Portal/index.html"><input type="button" value="logout" class="button3"></a><br>
<?php } ?>
