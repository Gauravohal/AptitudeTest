...
<body><center>
<div class="title">Quantitative Quiz</div>
<?php 														
                                $count =0;
                              ...
                              //  echo $_SESSION['clicks'];
                                ...
                                //  $c=40;
																...
																//echo($_SESSION['clicks']);
																?>
<div class="bump"><br><form><?php if($_SESSION['clicks']==0){ ?> <button class="button" name="start" float="left"><span>START QUIZ</span></button>
...
<table>
  ...
  <tr><td><b><li>Score will be displayed after the submitting the test.</li></b><br></td></tr>
</table>
 <?php } ?></form></div>


<form action="" method="post">  				
<table class="table1"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `quiz` where id='$c' and subid=1"; 
 ...
 <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] <11){
  ...
  <tr><td><center><button class="button3" name="click" ><?php echo $button_name; ?></button></center></td></tr> <?php }  
																	?> 
  <form>
