...
<body><center>
<div class="title">Verbal Quiz</div>
<?php 															
                                ...
                                //  $c=40;
																...
																?>
<div class="bump"><br><form><?php if($_SESSION['clicks']==39){ ?> <button class="button" name="start" float="left"><span>START QUIZ</span></button>
...
<table class="table1"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `quiz` where id='$c' and subid=2"; 
				$result=mysqli_query($conn,$fetchqry);
				$num=mysqli_num_rows($result);
				$row = mysqli_fetch_array($result,MYSQLI_ASSOC); }
		  ?>
<?php if($_SESSION['clicks'] > 39 && $_SESSION['clicks'] < 50){
  $button_name;
  if($_SESSION['clicks']<49)
  {
   $button_name = "Next";
  }
  else
